# TOOLS.md — every OSS tool registered for EstateIQ

This file is the single inventory of every OSS tool wired up for EstateIQ.
...
| networking | [geoserver](networking/geoserver/) | `networking/geoserver/` (scaffold) |
...
| networking | [pelias](networking/pelias/) | `networking/pelias/` (scaffold) |
...
| domain-oss | [geoserver](domain-oss/geoserver/) | `domain-oss/geoserver/` (deployable) |
| domain-oss | [nominatim](domain-oss/nominatim/) | `domain-oss/nominatim/` (deployable) |
| domain-oss | [pgrouting](domain-oss/pgrouting/) | `domain-oss/pgrouting/` (deployable) |
