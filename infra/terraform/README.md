# Terraform â€” EstateIQ Multi-Cloud Infrastructure

Each cloud has a **complete, standalone** deployment path. A team can pick **AWS,
GCP, or Azure** and bring up the entire EstateIQ platform on it without depending
on the other clouds.
...
in any of them brings up a full EstateIQ-ready cluster on that cloud.
