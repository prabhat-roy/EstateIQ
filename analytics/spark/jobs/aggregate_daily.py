...
spark = SparkSession.builder.appName("estateiq-aggregate-daily").getOrCreate()
df = spark.read.format("iceberg").load("estateiq_mart.events_raw")
...
result.writeTo("estateiq_mart.fct_daily_metrics").using("iceberg").overwritePartitions()
